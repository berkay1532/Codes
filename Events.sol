...
contract Events{
    ...
    //indexed keyword ü ile işaretlenmiş variable arama yaparken filtre olarak kullanılabilir. ex: 0x..... adresli consumerın oluşturduğu orderları göster
    event OrderCreated(uint _orderId,address indexed consumer);
    event ZipUpdated(uint _orderId,string _zipCode);
